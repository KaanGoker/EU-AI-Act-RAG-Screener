...
Powered by **Google Gemini** (`gemini-2.5-flash-lite` + `gemini-embedding-001`), the app aims for fast responses while staying anchored to the source text.
...
- **Gemini integration**: Uses `gemini-2.5-flash-lite` for reasoning and `gemini-embedding-001` for retrieval.
